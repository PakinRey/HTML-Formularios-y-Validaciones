...
const mensajesDeError = {
    ...
    password: {
        ...
        patternMismatch: 'Al menos 6 caracteres, Máximo 12, debe contener una letra minúscula, una letra mayuscula y 1 Número y no puede contener caracteres especiales.'
    },
    nacimiento: {
        valueMissing: 'Este campo no puede estar vacio',
    ...
    numero: {
        valueMissing: 'El número no puede estar vacio',
        patternMismatch: 'El formato Correcto es solo Numeros',
    },
    direccion: {
    ...
    estado: {
        ...
        patternMismatch: 'El Estado debe contener entre 5 a 40 Caracteres.',
    },
    ciudad: {
